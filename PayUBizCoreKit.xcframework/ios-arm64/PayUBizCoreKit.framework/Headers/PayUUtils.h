...
+(NSNumber *)getNumberValue:(NSDictionary *) dict forKey:(NSString *)key;

+(BOOL)getBoolValue:(NSDictionary *) dict forKey:(NSString *)key;
...
+ (NSString *)getTPVRequestString:(PayUModelPaymentParams *)paymentParam;
